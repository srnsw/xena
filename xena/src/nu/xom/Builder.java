...
public class Builder {
	...
	private static String[] parsers =
	    {
	     ...
	     "com.sun.org.apache.xerces.internal.parsers.SAXParser", "gnu.xml.aelfred2.XmlReader", "org.apache.crimson.parser.XMLReaderImpl",
	     "com.bluecast.xml.Piccolo", "oracle.xml.parser.v2.SAXParser", "com.jclark.xml.sax.SAX2Driver", "net.sf.saxon.aelfred.SAXDriver",
	     "com.icl.saxon.aelfred.SAXDriver", "org.dom4j.io.aelfred2.SAXDriver", "org.dom4j.io.aelfred.SAXDriver"};
	...
	private static void setupParser(XMLReader parser, boolean validate) throws SAXNotRecognizedException, SAXNotSupportedException {
		...
		if (parserName.equals("nu.xom.XML1_0Parser") || parserName.equals("nu.xom.JDK15XML1_0Parser")
		    || parserName.equals("org.apache.xerces.parsers.SAXParser") || parserName.equals("com.sun.org.apache.xerces.internal.parsers.SAXParser")
	...
	private static boolean knownGoodParser(XMLReader parser) {
		...
		for (String parser2 : parsers) {
			if (parserName.equals(parser2)) {
				return true;
			}
		}
		return false;
	...
	private void setHandlers() {
		...
		XOMHandler handler;
		if ((factory == null || factory.getClass().getName().equals("nu.xom.NodeFactory")) && knownGoodParser(parser)) {
	 ...
	 */
	public Document build(InputSource in) throws ParsingException, ValidityException, IOException {
	...
	private static class ValidityRequired implements ErrorHandler {
		...
		public void error(SAXParseException exception) {
			...
			if (vexception == null) {
				vexception =
				    new ValidityException(exception.getMessage(), exception.getSystemId(), exception.getLineNumber(), exception.getColumnNumber(),
				                          exception);
			}
