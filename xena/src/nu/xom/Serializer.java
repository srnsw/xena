...
public class Serializer {
	...
	private void setOutputStream(OutputStream out, String encoding) throws UnsupportedEncodingException {
		...
		} else if (encodingUpperCase.equals("UTF-16") || encodingUpperCase.equals("ISO-10646-UCS-2")) {
		...
		// provide our own.
		else if (encodingUpperCase.equals("IBM037") || encodingUpperCase.equals("CP037") || encodingUpperCase.equals("EBCDIC-CP-US")
		         || encodingUpperCase.equals("EBCDIC-CP-CA") || encodingUpperCase.equals("EBCDIC-CP-WA") || encodingUpperCase.equals("EBCDIC-CP-NL")
		         || encodingUpperCase.equals("CSIBM037")) {
			writer = new EBCDICWriter(out);
		} else if (encodingUpperCase.equals("ISO-8859-11") || encodingUpperCase.equals("TIS-620")) {
	...
	// JRW - added this method so that existing code will not break. 
	// Writes out the declaration by default.
	/**
	 * Writes out a document, including the XML Declaration
	 * @param doc
	 * @throws IOException
	 */
	...
	// JRW we do not want to write out the declaration if we are serialising an HTML file for
	// viewing in the Java HTML panel, as it will be displayed and looks broken.
	/**
	 * <p>
	 ...
	 */
	public void write(Document doc, boolean writeDeclaration) throws IOException {
