...
public class XenaTester {
	...
	private void showPluginDetails() {
		...
		for (Iterator iter = xena.getPluginManager().getViewManager().getAllViews().iterator(); iter.hasNext();) {
			...
			System.out.println("Viewer name: " + view.toString() + " and type:" + view.getViewType() + " and finally, the class:"
	...
	private void doBasicNormalising(List<File> fileList, File destinationDir) throws XenaException, FileNotFoundException, IOException {
