...
public class ViewerMainFrame extends JFrame {
	...
	private void initGUI() {
		...
		GridBagConstraints gbc =
		    new GridBagConstraints(0, 0, GridBagConstraints.RELATIVE, GridBagConstraints.RELATIVE, 1.0, 1.0, GridBagConstraints.NORTHWEST,
		                           GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0);
		mainPanel.add(logoLabel, gbc);

		gbc =
		    new GridBagConstraints(1, 0, GridBagConstraints.REMAINDER, GridBagConstraints.RELATIVE, 0.0, 0.0, GridBagConstraints.WEST,
		                           GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0);
		mainPanel.add(titleText, gbc);

		gbc =
		    new GridBagConstraints(0, 1, GridBagConstraints.RELATIVE, GridBagConstraints.REMAINDER, 0.0, 0.0, GridBagConstraints.CENTER,
		                           GridBagConstraints.NONE, new Insets(20, 30, 20, 20), 0, 0);
		mainPanel.add(openButton, gbc);

		gbc =
		    new GridBagConstraints(1, 1, GridBagConstraints.REMAINDER, GridBagConstraints.REMAINDER, 0.0, 0.0, GridBagConstraints.CENTER,
		                           GridBagConstraints.NONE, new Insets(20, 30, 20, 20), 0, 0);
	...
	public void displayView(File xenaFile) throws XenaException, IOException {
		...
		NormalisedObjectViewFactory novFactory = new NormalisedObjectViewFactory(xena);
	...
	public void handleException(Exception ex) {
		ex.printStackTrace();
		JOptionPane.showMessageDialog(this, ex.getMessage(), "Xena", JOptionPane.ERROR_MESSAGE);
	}
