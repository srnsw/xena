 ...
 *
 */
public class NaaSearchableAIPWrapper extends AbstractMetaDataWrapper {

	public static final String NAA_SEARCHABLE_WRAPPER_NAME = "NAA Searchable AIP Wrapper";
	...
	public String getName() {
		return NAA_SEARCHABLE_WRAPPER_NAME;
	}
