                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            if (uri.getScheme().equals("file")) {
                                ...
                                if (realativePath == null) {
                                    realativePath = file.getAbsolutePath();
                                }
                                //notout
                                //System.out.println("Path: " + realativePath);
                                String encodedPath = null;
                                try {
                                    encodedPath = au.gov.naa.digipres.xena.helper.UrlEncoder.encode(realativePath);
