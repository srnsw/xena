...
/* Creation date Thu Nov 15 15:01:20 EST 2007 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1195099280585L). */
   private static Date buildDate = new Date(1195099280585L);

   /**
    * Get buildDate (set during build process to Thu Nov 15 15:01:20 EST 2007).
