...
/* Creation date Fri Nov 16 11:23:08 EST 2007 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1195172588056L). */
   private static Date buildDate = new Date(1195172588056L);

   /**
    * Get buildDate (set during build process to Fri Nov 16 11:23:08 EST 2007).
