...
/* Creation date Fri Nov 16 15:17:24 EST 2007 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1195186644409L). */
   private static Date buildDate = new Date(1195186644409L);

   /**
    * Get buildDate (set during build process to Fri Nov 16 15:17:24 EST 2007).
