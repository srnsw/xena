...
/*
 * * Class to produce a searchable AIP from office documents.
 * 
 * @author justin
 */
public class OfficeSearchableNormaliser extends AbstractSearchableNormaliser {
	...
	public String getName() {
		return "Office Searchable Normaliser";
	}
