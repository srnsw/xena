...
/* Creation date Thu Nov 15 14:40:44 EST 2007 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1195098044512L). */
   private static Date buildDate = new Date(1195098044512L);

   /**
    * Get buildDate (set during build process to Thu Nov 15 14:40:44 EST 2007).
   ...
   /** version (set during build process to "2.1.0"). */
   private static String version = new String("2.1.0");

   /**
    * Get version (set during build process to "2.1.0").
