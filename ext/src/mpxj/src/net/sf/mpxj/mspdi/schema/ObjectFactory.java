 ...
 * 
 */
@XmlRegistry @SuppressWarnings("all") public class ObjectFactory
{
   ...
   /**
    * Create an instance of {@link Project.Calendars.Calendar.WorkWeeks.WorkWeek.WeekDay }
    * 
    */
   public Project.Calendars.Calendar.WorkWeeks.WorkWeek.WeekDay createProjectCalendarsCalendarWorkWeeksWorkWeekWeekDay()
   {
      return new Project.Calendars.Calendar.WorkWeeks.WorkWeek.WeekDay();
   }
