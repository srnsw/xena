...
/* Creation date Tue Sep 01 15:21:08 EST 2009 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1251782468938L). */
   private static Date buildDate = new Date(1251782468938L);

   /**
    * Get buildDate (set during build process to Tue Sep 01 15:21:08 EST 2009).
   ...
   /** project (set during build process to "postscript"). */
   private static String project = new String("postscript");

   /**
    * Get project (set during build process to "postscript").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "1.1"). */
   private static String version = new String("1.1");

   /**
    * Get version (set during build process to "1.1").
