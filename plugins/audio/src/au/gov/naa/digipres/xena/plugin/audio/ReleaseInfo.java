...
/* Creation date Fri Mar 18 13:56:57 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417017721L). */
   private static Date buildDate = new Date(1300417017721L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:56:57 EST 2011).
   ...
   private static String project = new String("audio");

   /**
    * Get project (set during build process to "audio").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "0.5.5"). */
   private static String version = new String("0.5.5");

   /**
    * Get version (set during build process to "0.5.5").
