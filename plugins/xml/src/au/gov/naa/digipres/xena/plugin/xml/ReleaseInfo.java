...
/* Creation date Tue Jun 09 15:45:55 EST 2009 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1244526355937L). */
   private static Date buildDate = new Date(1244526355937L);

   /**
    * Get buildDate (set during build process to Tue Jun 09 15:45:55 EST 2009).
