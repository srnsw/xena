...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1287374924725L). */
   private static Date buildDate = new Date(1287374924725L);
   ...
   /** project (set during build process to "naa"). */
   private static String project = new String("naa");

   /**
    * Get project (set during build process to "naa").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "3.2.2"). */
   private static String version = new String("3.2.2");

   /**
    * Get version (set during build process to "3.2.2").
