...
/* Creation date Mon Oct 18 15:08:35 EST 2010 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1287374915393L). */
   private static Date buildDate = new Date(1287374915393L);

   /**
    * Get buildDate (set during build process to Mon Oct 18 15:08:35 EST 2010).
