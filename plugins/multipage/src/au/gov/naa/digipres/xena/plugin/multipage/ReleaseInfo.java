...
/* Creation date Fri Oct 29 14:29:38 EST 2010 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1288322978968L). */
   private static Date buildDate = new Date(1288322978968L);

   /**
    * Get buildDate (set during build process to Fri Oct 29 14:29:38 EST 2010).
