...
/* Creation date Fri Mar 18 13:57:21 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417041028L). */
   private static Date buildDate = new Date(1300417041028L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:57:21 EST 2011).
