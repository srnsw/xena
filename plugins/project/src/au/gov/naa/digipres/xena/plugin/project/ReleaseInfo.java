...
/* Creation date Fri Mar 18 13:57:40 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417060594L). */
   private static Date buildDate = new Date(1300417060594L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:57:40 EST 2011).
   ...
   /** version (set during build process to "2.2.2"). */
   private static String version = new String("2.2.2");

   /**
    * Get version (set during build process to "2.2.2").
