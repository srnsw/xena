 ...
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "TimephasedDataType", propOrder =
{
   "type",
   "uid",
   "start",
   ...
   "unit",
   "value"
}) @SuppressWarnings("all") public class TimephasedDataType
{

   @XmlElement(name = "Type") protected BigInteger type;
   @XmlElement(name = "UID", required = true) protected BigInteger uid;
   @XmlElement(name = "Start", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Calendar start;
   @XmlElement(name = "Finish", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Calendar finish;
