...
public class SxiFileType extends OfficeFileType {
	...
	public String getOfficePropertiesName() {
		return OfficeProperties.OOO_PR_OUTPUT_FORMAT;
	}
	...
	public String getOfficeConverterName(String strOutputTypeName) {
		return PresentationOutputType.getOfficeConverterName(strOutputTypeName);
	}
	...
	public String getODFExtension(String strOutputTypeName) {
		return PresentationOutputType.getOutputFileExtension(strOutputTypeName);
	}
