...
/* Creation date Fri Mar 18 13:56:50 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417010756L). */
   private static Date buildDate = new Date(1300417010756L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:56:50 EST 2011).
   ...
   /**
    * Get buildNumber (set during build process to 12).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 12; }


   /** project (set during build process to "archive"). */
   private static String project = new String("archive");

   /**
    * Get project (set during build process to "archive").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "1.2.5"). */
   private static String version = new String("1.2.5");

   /**
    * Get version (set during build process to "1.2.5").
