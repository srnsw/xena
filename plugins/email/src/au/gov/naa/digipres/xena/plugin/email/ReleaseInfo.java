...
/* Creation date Fri Mar 18 13:57:04 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417024771L). */
   private static Date buildDate = new Date(1300417024771L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:57:04 EST 2011).
   ...
   /** version (set during build process to "3.2.4"). */
   private static String version = new String("3.2.4");

   /**
    * Get version (set during build process to "3.2.4").
