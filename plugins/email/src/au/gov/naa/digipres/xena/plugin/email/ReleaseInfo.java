...
/* Creation date Fri Oct 29 14:29:30 EST 2010 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1288322970667L). */
   private static Date buildDate = new Date(1288322970667L);

   /**
    * Get buildDate (set during build process to Fri Oct 29 14:29:30 EST 2010).
