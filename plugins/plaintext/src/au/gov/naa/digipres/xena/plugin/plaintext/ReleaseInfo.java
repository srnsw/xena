...
/* Creation date Fri Mar 18 13:57:38 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417058294L). */
   private static Date buildDate = new Date(1300417058294L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:57:38 EST 2011).
   ...
   private static String project = new String("plaintext");

   /**
    * Get project (set during build process to "plaintext").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "3.4.3"). */
   private static String version = new String("3.4.3");

   /**
    * Get version (set during build process to "3.4.3").
