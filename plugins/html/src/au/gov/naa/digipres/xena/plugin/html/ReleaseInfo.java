...
/* Creation date Fri Mar 18 13:57:09 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417029946L). */
   private static Date buildDate = new Date(1300417029946L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:57:09 EST 2011).
   ...
   /** project (set during build process to "html"). */
   private static String project = new String("html");

   /**
    * Get project (set during build process to "html").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "2.4.8"). */
   private static String version = new String("2.4.8");

   /**
    * Get version (set during build process to "2.4.8").
