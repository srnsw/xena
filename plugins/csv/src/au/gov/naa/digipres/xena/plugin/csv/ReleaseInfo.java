...
/* Creation date Fri Oct 29 14:29:28 EST 2010 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1288322968136L). */
   private static Date buildDate = new Date(1288322968136L);

   /**
    * Get buildDate (set during build process to Fri Oct 29 14:29:28 EST 2010).
