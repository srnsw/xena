...
/* Creation date Fri Oct 29 14:29:36 EST 2010 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1288322976726L). */
   private static Date buildDate = new Date(1288322976726L);

   /**
    * Get buildDate (set during build process to Fri Oct 29 14:29:36 EST 2010).
