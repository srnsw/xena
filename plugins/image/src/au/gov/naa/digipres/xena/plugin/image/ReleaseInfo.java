...
/* Creation date Fri Mar 18 13:57:16 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1300417036943L). */
   private static Date buildDate = new Date(1300417036943L);

   /**
    * Get buildDate (set during build process to Fri Mar 18 13:57:16 EST 2011).
   ...
   /** project (set during build process to "image"). */
   private static String project = new String("image");

   /**
    * Get project (set during build process to "image").
    * @return String project
    */
   public static final String getProject() { return project; }


   /** version (set during build process to "4.5.5"). */
   private static String version = new String("4.5.5");

   /**
    * Get version (set during build process to "4.5.5").
