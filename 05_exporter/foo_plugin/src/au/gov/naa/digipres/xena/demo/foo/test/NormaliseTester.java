...
public class NormaliseTester {
	public static void main(String[] argv) throws XenaException, IOException {
		...
		File f = new File("example_file.foo");
        ...
        String exportFileName = results.getOutputFileName();
        File fileToExport = new File(exportFileName);
        xena.export(new XenaInputSource(fileToExport), new File(System.getProperty("user.dir")));
	}
}